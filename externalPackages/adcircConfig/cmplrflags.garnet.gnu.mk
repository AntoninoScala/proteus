...
ifeq ($(compiler),gnu)
  ...
  ifeq ($(DEBUG),full)
     FFLAGS1	:=  $(INCDIRS) -Mextend -g -O0 -Mbounds -Mchkfpstk -Mchkptr -Mchkstk -DALL_TRACE -DFLUSH_MESSAGES -DFULL_STACK -tp=shanghai-64
  else
     FFLAGS1	:=  $(INCDIRS) -O2 -mcmodel=medium -ffixed-line-lenth-132 -march=k8 -m64	
  endif
  FFLAGS2	:=  $(FFLAGS1)
  FFLAGS3	:=  $(FFLAGS1) 
