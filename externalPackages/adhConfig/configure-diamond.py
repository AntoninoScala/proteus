...
parmetis_dir     = os.path.join(externalPackages,'adh-externals','ParMetis') #'adh-ParMetis-3.2.0')
#adh requires UMFPACK 3.2
umfpack_dir      = os.path.join(externalPackages,'adh-externals','UMFPACK') #'adh-UMFPACK3.2')

CMAKE = 'cmake' #os.path.join(proteus,proteus_arch,'bin','cmake')

adh_config_variables = {'CMAKE_C_COMPILER':'/opt/intel/impi/4.0.3/bin64/mpiicc',
                        'CMAKE_CXX_COMPILER':'/opt/intel/impi/4.0.3/bin64/mpiicpc',
                        'CMAKE_Fortran_COMPILER':'/opt/intel/impi/4.0.3/bin64/mpiifort',
                        'BUILD_PRE_ADH':'ON',
